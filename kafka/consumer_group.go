...
// NewConsumerGroup :
func NewConsumerGroup(brokers map[int]string, consumerTopic, consumerGroup, assignor, version string, verbose, oldest, printMessage bool, gauge *prometheus.Gauge) *ConsumerGroup {
